...
\begin{lstlisting}[language={[ANSI]C++},caption={Example code},label={Example code}]
...
\begin{figure}[htb]
	\begin{center}
	\includegraphics[scale=1,trim=0 0 0 0]{content/frontmatter/sdu_logo.pdf} %trim=l b r t (can cut off from every side)
	\caption{SDU logo}
