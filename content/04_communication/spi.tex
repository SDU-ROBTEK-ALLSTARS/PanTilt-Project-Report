\section{SPI software on the microprocessor}
...
\begin{figure}[htb]
  \centering
  \fbox{\includegraphics[width=\textwidth,clip,trim=90 110 90 110]{content/04_communication/figures/spi_task_diagram_running.pdf}}
