...
\AddToShipoutPictureBG*{%background picture
 \put(0,0){
  \parbox[b][\paperheight][b]{\paperwidth}{%\parbox[position][height][inner-pos]{width}{text}
   \vfill
   %\begin{flushright}
   \includegraphics[width=0.43\paperwidth,trim=110 0 0 0]{content/frontmatter/sdu_seal.pdf}%trim=l b r t
   %\end{flushright}
   \vspace*{2.9cm}
  }
 }
...
\begin{flushright}
\includegraphics[scale=0.73]{content/frontmatter/sdu_logo.pdf}
\end{flushright}
\vspace*{2.7cm}
%
