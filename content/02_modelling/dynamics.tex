...
\begin{figure}[htb]
	\begin{center}
	\includegraphics[scale=1,trim=0 0 0 0]{graphics/CrapSim.pdf} %trim=l b r t (can cut off from every side)
...
\begin{figure}[htb]
	\begin{center}
	\includegraphics[scale=1,trim=0 0 0 0]{graphics/GoodSim.pdf} %trim=l b r t (can cut off from every side)
...
\begin{figure}[htb]
	\begin{center}
	\includegraphics[scale=1,trim=0 0 0 0]{graphics/ZoomOpenLoop.pdf} %trim=l b r t (can cut off from every side)
