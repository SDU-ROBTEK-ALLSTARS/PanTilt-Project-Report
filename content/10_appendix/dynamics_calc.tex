...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth,trim=0 20 0 10]{graphics/pan_tilt_sketch.pdf} %trim=l b r t (can cut off from every side)
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=1,trim=0 20 0 10]{graphics/gears.pdf} %trim=l b r t (can cut off from every side)
